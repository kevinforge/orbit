...
除非本项目明确宣布已经拥有 npm 包名，否则不要直接从公开 npm 执行
`npm install -g orbit`：公开 npm 上的 `orbit` 是另一个同名项目，可能会在
...
Orbit 使用 [MIT License](LICENSE) 开源。安全问题请按 [SECURITY.md](SECURITY.md)
中的方式报告。
